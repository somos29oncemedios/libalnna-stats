...
export default async function HomePage() {
  ...
  return (
    // AQUÍ ESTÁ EL AJUSTE DEL FONDO A #EDEDED
    <main style={{ background: '#EDEDED', minHeight: '100vh', color: '#000000', fontFamily: 'system-ui, -apple-system, sans-serif', paddingBottom: '60px' }}>
      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <span style={{ background: '#ffffff', color: '#000000', fontWeight: '900', padding: '6px 18px', borderRadius: '24px', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '1px', display: 'inline-block', marginBottom: '20px' }}>
            Portal Oficial
          </span>
          <h1 style={{ fontSize: '4.5rem', margin: '0 0 10px 0', color: '#ffffff', textTransform: 'uppercase', letterSpacing: '2px', fontWeight: '900' }}>
            LIBALNNA
          </h1>
